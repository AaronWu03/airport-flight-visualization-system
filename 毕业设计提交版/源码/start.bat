...
$backendJob = Start-Process -FilePath "node" -ArgumentList "server\mcp-proxy.js" -WorkingDirectory $scriptDir -NoNewWindow -PassThru -RedirectStandardError "server-error.log"
